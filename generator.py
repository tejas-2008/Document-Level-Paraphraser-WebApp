...
from    preprocess import data_process, data_loader, graph_process
from    utils import constants
import  os
...
def _main():
    ...
    if args.file is not None:
        ...
        source = data_process(file=args.raw_file,
                              word2index=src_word2index)
        graph = '/home/tejas/dlops_project/CoRPG/data/news-commentary/data/test.graph'
        data = data_loader(source=source,
                           PAD_index=constants.PAD_index, graph=graph)
